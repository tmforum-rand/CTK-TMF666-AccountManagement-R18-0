...
var DefaultURL = "http://tm-forum-open-api-reference-implementation.mybluemix.net/tmf-api/accountManagement/v2/";
var schema;
var hostname;
var port;
var APIRelativeAddress;
var statusCode;
const exampleEndPoint = "partyAccount";
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout
});

console.log("////////////////////////////////////////////////////////////////////////\nWelcome to the Conformance Test Kit for TMF666 AccountManagement\n");
getURL();
...
function runNewman(){
    ...
    newman.run({
        collection: require('./CTK-TMF666-AccountManagement.postman_collection.json'),
