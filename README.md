...
Once Node.js and npm are installed download and unzip the CTK-TMF666-AccountManagement ZIP file within your test directory.
...
>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/accountManagement/v2/partyAccount

You should input:
>>http://tm-forum-open-api-reference-implementation.mybluemix.net:80/tmf-api/accountManagement/v2/
...
![CTK Example Image](https://github.com/tmforum-rand/CTK-TMF666-AccountManagement/blob/master/CTK-TMF666-AccountManagement/Output-Example.png)
